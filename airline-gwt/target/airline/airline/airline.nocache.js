function airline(){
  ...
  airline.__sendStats = sendStats;
  airline.__moduleName = $intern_4;
  airline.__errFn = null;
  airline.__moduleBase = $intern_6;
  airline.__softPermutationId = $intern_7;
  airline.__computePropValue = null;
  airline.__getPropMap = null;
  airline.__installRunAsyncCode = function(){
  }
  ;
  airline.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  airline.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  airline.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  airline.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[airline.__softPermutationId];
    ...
    function installCode(code_0){
      ...
      if (airline.__errFn) {
        script.onerror = function(){
          airline.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  airline.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  airline.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    airline.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return airline.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    airline.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = airline.__getPropMap;
    ...
    airline.__softPermutationId = softPermutationId;
  ...
  processMetas();
  airline.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = airline.__moduleBase;
